...
# mesh = Mesh(original_nodes, mesh.cells)
...
observed_positions_2 = original_positions + onp.array(u_sol_2)
mesh_cc = mesh
mesh_cc.points[non_fixed_nodes] = observed_positions_2[non_fixed_nodes].reshape((-1, 3))


print(mesh_cc.points)
print(mesh_cc.cells)
