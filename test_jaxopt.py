...
def loss_function(init_non_fixed_nodes_flat):
    ...
    # regularization = onp.sum((original_nodes - original_positions)**2)
    total_loss = loss_2 + loss_3
...
print(init_non_fixed_nodes_flat.shape)
...
optimized_original_nodes_flat = original_positions.at[non_fixed_nodes].set(optimized_original_nodes_flat.reshape((-1, 3)))
...
# Save to CSV files
undeformed_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/undeformed_coordinates.csv", index=False)
initial_gauss_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/initial_gauss_coordinates.csv", index=False)
optimized_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/optimized_coordinates.csv", index=False)

# Save to CSV files
# undeformed_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/undeformed_coordinates.csv", index=False, float_format="%.5f")
# initial_gauss_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/initial_gauss_coordinates.csv", index=False, float_format="%.5f")
# optimized_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/optimized_coordinates.csv", index=False, float_format="%.5f")
