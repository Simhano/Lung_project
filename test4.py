...
def loss_function(non_fixed_nodes_flat):
    ...
    initial_displacements = original_nodes
    ...
    #     internal_pressure=internal_pressure_2
    # )
    # Define the forward problem with the current mesh
    problem_current_2 = HyperElasticity(
        ...
        dirichlet_bc_info=dirichlet_bc_info,
        location_fns=location_fns,
        internal_pressure=2.0  # Use the pressure you need
    )
    ...
    problem_current_3 = HyperElasticity(
        ...
        dirichlet_bc_info=dirichlet_bc_info,
        location_fns=location_fns,
        internal_pressure=3.0  # Use the pressure you need
    )
