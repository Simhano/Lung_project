...
print(u_sol_2)
vtk_path_2 = os.path.join(data_dir, 'vtk', 'u_undeformed_config_body_hemi_non_post_itni_fine_untangle.vtu')
...
vtk_path_opt = os.path.join(data_dir, 'vtk', 'u_pressure_opt_with_JAX_body_before_opt_hemi_non_post_itni_fine_untangle.vtu')
...
with open("cost_history_learning_rate_body_hemi_non_post_itni_fine_untangle.csv", "w", newline="") as file:
...
u_sol_opt = sol_list[0]
vtk_path_opt = os.path.join(data_dir, 'vtk', 'u_pressure_opt_with_JAX_body_hemi_non_post_itni_fine_untangle.vtu')
os.makedirs(os.path.dirname(vtk_path_opt), exist_ok=True)
save_sol(problem.fes[0], u_sol_opt, vtk_path_opt)
...
# Save to CSV files
undeformed_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/By_SciPy/undeformed_coordinates_JAX_body_hemi_non_post_itni_fine_untangle.csv", index=False)
initial_gauss_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/By_SciPy/initial_gauss_coordinates_body_hemi_non_post_itni_fine_untangle.csv", index=False)
optimized_df.to_csv("/home/gusdh/jax-fem/demos/hyperelasticity/jax-fem/demos/prac_hy/data/By_SciPy/optimized_coordinates_body_hemi_non_post_itni_fine_untangle.csv", index=False)
